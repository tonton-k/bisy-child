...
<div class="single-course-area">
	<div class="course-top">
		...
		<div class="course-meta">
			<div class="author">
				...
				<a
					href="<?php echo esc_url($instructor_profile_link); ?>"><?php echo esc_html($instructor->get_display_name()); ?></a>
			</div>
	...
	<div class="course-tab-wrapper">
		<ul class="course-tab-btn nav nav-tabs">
			<li><a href="#overview" data-toggle="tab"><i
						class="icon_ribbon_alt"></i><?php echo esc_html__('コース概要', 'bisy'); ?></a></li>
			<li><a href="#curriculum" data-toggle="tab"><i class="icon_book_alt"></i>
					<?php echo esc_html__('カリキュラム', 'bisy'); ?> </a></li>
			<li><a class="active" href="#instructors" data-toggle="tab"><i
						class="icon_profile"></i><?php echo esc_html__('インストラクター', 'bisy'); ?></a></li>
			<?php if (function_exists('learn_press_get_course_review')): ?>
			<li><a href="#reviews" data-toggle="tab"><i class="icon_star"></i> <?php echo esc_html__('レビュー', 'bisy'); ?>
				</a></li>
			<?php endif; ?>
		</ul>
		<!-- Tab Content -->
					...
					<div class="card-header" id="cc_<?php echo esc_attr($kl); ?>">
						<h5 class="mb-0">
							<button class="btn btn-link" data-toggle="collapse"
								data-target="#acc_<?php echo esc_attr($kl); ?>" aria-expanded="true"
								aria-controls="acc_<?php echo esc_attr($kl); ?>">
								<?php echo esc_html($section->get_title()); ?>
							</button>
						</h5>
					</div>
					<div id="acc_<?php echo esc_attr($kl); ?>" class="collapse show"
						aria-labelledby="cc_<?php echo esc_attr($kl); ?>"
						data-parent="#id_<?php echo esc_attr($kl); ?>">
						<div class="card-body">
							...
							<div class="ci-item <?php echo esc_attr($ls_k % 2 != 0?'with-bg':''); ?> ">
								<h5>
									...
									<a href="<?php echo esc_url($lesson->get_permalink()); ?>">
										<?php echo esc_html($lesson->get_title()); ?> </a>
								</h5>
								...
								<div class="ci-tools">
									...
									<a href="<?php echo esc_url($lesson->get_permalink()); ?>" class="lock"><i
											class="<?php echo esc_attr($lesson->is_preview()?'fas fa-eye':'icon_lock_alt'); ?> "></i></a>
								</div>
							</div>
							<?php endforeach; ?>
						</div>
			...
			<div class="tab-pane fade in show active" id="instructors" role="tabpanel">
				...
				<div class="teacher-item-3">
					...
					<div class="teacher-thumb">
						<img src="<?php echo esc_url($profile_link); ?>"
							alt="<?php echo esc_attr($teacher_info->display_name); ?>">
					</div>
					<?php endif; ?>
					<div class="teacher-meta">
						<?php if (isset($teacher_info->display_name)): ?>
						<h5><a href="<?php echo esc_url($url); ?>"> <?php echo esc_html($teacher_info->display_name); ?>
							</a></h5>
						<?php endif; ?>
						...
						<div class="teacher-social">
							...
							<a href="<?php echo esc_url($user_social['url']); ?>"><i
									class="<?php echo esc_attr($user_social['icon']); ?>"></i></a>
							<?php endforeach; ?>
			...
			<div class="tab-pane fade in" id="reviews" role="tabpanel">
				...
				<div class="reviw-area">
						...
						<div class="average-rate">
							...
							<div class="rate-box">
								...
								<div class="ratings">
									...
									<i
										class="icon_star <?php echo esc_attr($number<=$course_rate?'active':'inactive'); ?>"></i>
									<?php endforeach; ?>
								...
								<div class="rate-item">
									...
									<div class="progress">
										<div class="progress-bar" role="progressbar"
											style="width: <?php echo esc_attr($rating_item['percent']); ?>%;"
					...
					<div class="review-rating">
						<h5><?php echo esc_html__('Comments', 'bisy'); ?> (
							<?php echo esc_html($course_review['total']); ?> )</h5>
						<ol>
							...
							<li>
								<div class="single-comment">
									<img src="<?php echo esc_url(get_avatar_url($review->ID)); ?>"
										alt="<?php echo esc_attr($review->display_name); ?>">
									<h5><a href="#"> <?php echo esc_html($review->display_name); ?> </a></h5>
									<span>
										<?php echo esc_html(get_comment_date('F d Y', $review->comment_id)).esc_html__(' at', 'bisy').esc_html(get_comment_date(' g:i a', $review->comment_id)); ?>
									</span>
									<div class="comment">
									...
									<div class="ratings">
										...
										<i
											class="icon_star <?php echo esc_attr($cnumber<=$comment_rate?'active':'inactive'); ?>"></i>
										<?php endforeach; ?>
									</div>
